...
<head>
    <meta charset="UTF-8">
    <title>Imperial Plantas - Platas especiais, flores, presentes e muito mais</title>
...
<!-- END-HEADER -->
<!-- SLIDER -->
<section id="slide_show" class="slide-h5">
    <div class="container-fluid">
        <div class="inner">
...
<!-- END / SLIDER -->
<!-- GALLERY -->
<section class="product product-v6">
    <div class="container">
        <div class="gallery-cat text-center">
            <h2 class="title-h3">Produtos e Serviços</h2>
        </div>
        <br/><br/>
        <div class="list-category-banner row">
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_05.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Flores</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_06.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Plantas para casa</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_04.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Cestas especiais</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_03.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Presentes</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_02.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Home office</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="items items-cate col-md-4 col-sm-6">
                <div class="wrap-box-1">
                    <div class="box-img">
                        <a href="" title="">
                            <img src="images/banner/banner_cate_h6_01.jpg" class="img-responsive" alt="Product" title="images products"></a>
                        <div class="content-item">
                            <h5 class="title-h5"><a href="" title="">Acessorios</a></h5>
                        </div>
    ...
    <div class="btn-web text-center btn-shadow">
        <a href="#" title="">Todos produtos e serviços</a>
    </div>
</section>
<!-- END / GALLERY -->
...
<!-- GALLERY -->
<section class="product product-v5">
    <div class="  wrap-blog   ">
        <div class="container">
            <div class="gallery gallery-restaurant clearfix">
                <!-- FILTER -->
                <div class="gallery-cat   text-center ">
                    <h2 class="title-h3">Blog</h2>
                </div>
                <!-- END / FILTER -->
                <!-- GALLERY CONTENT -->
                        ...
                        <div class="gallery-isotope col-4 ">
                            ...
                            <div class="item-isotope suite dining design">
                                <div class="wrap-box-1">
                                    <div class="box-img">
                                        <a href="">
                                            <img src="images/product/pro_07.jpg" class="img-responsive" alt="Product" title="images products"></a>
                                        <div class="content-item">
                                            <h5 class="title-h5"><a href="">Titulo da publicação 2</a></h5>
                                            <div class="bottom">
                            ...
                            <div class="item-isotope suite dining design">
                                <div class="wrap-box-1">
                                    <div class="box-img">
                                        <a href="">
                                            <img src="images/product/pro_09.jpg" class="img-responsive" alt="Product" title="images products"></a>
                                        <div class="content-item">
                                            <h5 class="title-h5"><a href="">Título da publicação 3</a></h5>
                                            <div class="bottom">
                                                <div class="text-right">
                                                    <span class="height">133 cm</span>
                                                </div>
                            ...
                            <div class="item-isotope suite dining design">
                                <div class="wrap-box-1">
                                    <div class="box-img">
                                        <a href="">
                                            <img src="images/product/pro_08.jpg" class="img-responsive" alt="Product" title="images products"></a>
                                        <div class="content-item">
                                            <h5 class="title-h5"><a href="">Titulo da publicação 4</a></h5>
                                            <div class="bottom">
...
<section class="section-slider-v5 ">
    <div class="bg clearfix">
        <h5 class=" title-h5"><i class="fa fa-instagram"></i>  Instagram</h5>
    </div>
    <div class="container">
        <div id="index122" class="owl-carousel  owl-theme">
            <div class="item">
                <div class="wrap-best">
                    <div class="icon-best">
                        <img src="images/banner/5.jpg" class="img-responsive" alt="Image">
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="wrap-best ">
                    <div class="icon-best">
                        <img src="images/banner/6.jpg" class="img-responsive" alt="Image">
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="wrap-best">
                    <div class="icon-best">
                        <img src="images/banner/7.jpg" class="img-responsive" alt="Image">
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="wrap-best ">
                    <div class="icon-best">
                        <img src="images/banner/8.jpg" class="img-responsive" alt="Image">
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="wrap-best ">
                    <div class="icon-best">
                        <img src="images/banner/9.jpg" class="img-responsive" alt="Image">
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-sm-12 copy-rodape">
        <div class="copyright text-rodape">
            Copyright © 2020 <a href="#">Imperial Plantas</a>.Desenvolvido por <a href="http://grudigital.com.br/">Grudigital</a>.
        </div>
    </div>
</div>
<!-- Menu offcanvas -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="get" class="searchform" action="#">
                <div class="pbr-search input-group">
                    <input name="search" maxlength="40" class="form-control input-large input-search" size="20" placeholder="Busar" type="text">
                    <span class="input-group-addon input-large btn-search">
                            <input value="" type="submit">
                        </span>
                </div>
...
<a href="https://wa.me/5511980246313?text=Adorei%20seu%20artigo" style="position:fixed;width:60px;height:60px;bottom:15px;left:10px;background-color:#80b435;color:#FFF;border-radius:50px;text-align:center;font-size:30px;box-shadow: 1px 1px 2px #888;
